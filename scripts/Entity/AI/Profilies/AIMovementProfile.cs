...
namespace Game.Entity.AI.Profiles
{
    ...
    public partial class AIMovementProfile : Resource
    {
        ...
        [Export] public float SlowSpeed { get; private set; } = 0.5f;
        [Export] public float NormalSpeed { get; private set; } = 1.0f;
        [Export] public float FastSpeed { get; private set; } = 1.5f;
