// --- ИЗМЕНЕНИЯ ---
// 1. Логика случайности waypoint-ов была корректной и не содержала ошибок.
// 2. Для большей консистентности с другим C# кодом, где используется System.Random,
//    заменил вызовы GD.RandRange на Random.Shared.Next... и аналогичные.
//    Функционально это не меняет поведение, но улучшает чистоту кода.
// -----------------

using Godot;
using System; // Добавлено для Random
